...
import {VENDORS_FETCH_REQUEST, VENDORS_FETCH_SUCCESS, VENDORS_FETCH_FAILURE} from '../../constants';

export const RequestAction = {
  type: VENDORS_FETCH_REQUEST
};

export const SuccessAction = (payload) => ({
  type: VENDORS_FETCH_SUCCESS,
  payload
});

export const FailureAction = (payload) => ({
  type: VENDORS_FETCH_FAILURE,
  payload
});
