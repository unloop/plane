...
const ServiceChartReplicas = (props) => {
  ...
  return (
    <svg width="120px" height="120px" viewBox="0 0 160 150">
      <circle cx="55" cy="75" r="50" fill="transparent" strokeWidth="5" stroke="grey"/>
      { provision > 0 ? (
        <g>
      ...
      <text x="55" y="75" fill="#ffffff" fontSize="18" textAnchor="middle">{props.value || 0}</text>
      <text x="55" y="95" fill="#ffffff" fontSize="12" textAnchor="middle">Replicas</text>
      <g className="cursor-pointer" transform="translate(110, 40)" onClick={(e) => props.submit(e, total + 1)}>
      ...
      <g className="cursor-pointer" transform="translate(110, 80)"
         onClick={(e) => props.submit(e, (total > 1) ? total - 1 : 1)}>
...
ServiceChartReplicas.propTypes = {
  state:  PropTypes.object.isRequired,
  submit: PropTypes.func.isRequired
};

export default ServiceChartReplicas;
